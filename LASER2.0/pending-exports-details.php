        ...
        <div class="py-4">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Pending Departure</li>
                </ol>
            </nav>
            <div class="d-flex justify-content-between w-100 flex-wrap">
                <div class="mb-3 mb-lg-0">
                    <h1 class="h4">Pending Departure</h1>
    ...
    $(document).ready(function() {
        ...
        if(selectDB == 'brokerage'){
          ...
          var filter = [{ 
            ...
            var columns = [
              ...
              { "data": "Consignee", "title": "Consignee", "width": "20%" },
              { "data": "DepartureDate", "width": "15%", "title": "Estimated Departure Date" ,
              ...
              { "data": "ArrivalDate", "width": "15%", "title": "Estimated Arrival Date" ,
              //   render: function (data, type, row) {
              //   if(new Date(data) && data != 'NA'){
              //     return moment(new Date(data).toString()).format('DD/MM/YYYY');
          ...
          { "data": "CountryOfDestination", "title": "Country of destination " , "width": "15%"},
          ...
          { "data": "days", "title": "Days To Depart", visible:false},
        ...
        $.getJSON('assets/data/customer_data.json', function(data) {         
               if(data.hasOwnProperty(consignee)){
                  try {  
                    var additional_cols = data[consignee].pending_exports.main_fields;
            ...
            "ajax": "functions/pendingExports.php?Data=" + selectDB,
            "columns": columns,
            "initComplete": function(settings, json) {
                $('.dt-button').addClass('btn btn-info');
                $('[data-toggle="tooltip"]').tooltip();
