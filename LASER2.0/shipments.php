        ...
        <div class="py-4">
            ...
            <div class="d-flex justify-content-between w-100 flex-wrap">
                <div class="mb-3 mb-lg-0">
                    <h1 class="h4">Pending Clearance</h1>
    ...
    $(document).ready(function() {
        ...
        if(selectDB == 'brokerage'){
          ...
          var columns = [
              ...
              { "data": "ArrivalDate", "width": "15%", "title": "Arrival Date" ,
          ...
          { "data": "days", "title": "Days Days From Arrival", visible:false},
        ...
        $.getJSON('assets/data/customer_data.json', function(data) {         
               if(data.hasOwnProperty(consignee)){
                  try {  
                    var additional_cols = data[consignee].imports.main_fields;
                    additional_cols.forEach(function(item, index){
