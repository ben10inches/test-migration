        ...
        <div class="py-4">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Esso Clearance & Delivery</li>
                </ol>
            </nav>
            <div class="d-flex justify-content-between w-100 flex-wrap">
                <div class="mb-3 mb-lg-0">
                    <h1 class="h4">Esso Clearance & Delivery</h1>
 ...
 function showEdit(editableObj) {
	...
	var table = $('#table').DataTable( {
      ...
      createdRow: function( row, data, dataIndex ) {
        var ID = data.ID;
        $( row ).find('td:eq(11)').attr('contenteditable', 'true');
        $( row ).find('td:eq(11)').attr('onBlur', 'saveToDatabase(this, ' + ID + ')');
        $( row ).find('td:eq(11)').attr('onClick', 'showEdit(this)');
      },
      
        "order": [[ 5, "desc" ]],
        "ajax":{
          url:"functions/kpi1.php?y=" + currentYear + '&m=all',
          type:"POST",
        ...
        columns : [
                ...
                {data: 'ArrivalDate'},
                {data: 'ModesofTransportation'},
                {data: 'DateShipmentCleared'},
                {data: 'CargoDelivered'},
                {data: 'kpi'},
                {data: 'kpi2'},
                {data: 'EssoComments'},
		...
		$( ".dates" ).change(function() {
			...
			var url = 'functions/kpi1.php?y=' + year +'&m=' + month;
